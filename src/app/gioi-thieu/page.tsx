...
export const metadata: Metadata = buildMetadata({
  title: "Giới Thiệu – Câu chuyện và đội ngũ Green Oli",
  description:
    "Hơn 10 năm phân phối hóa chất nông nghiệp tại Việt Nam. Tìm hiểu sứ mệnh, giá trị cốt lõi và đội ngũ kỹ sư của Green Oli.",
  path: "/gioi-thieu",
});
    ...
    <>
        ...
        <div className="grid gap-12 lg:grid-cols-12 items-center">
          <div className="lg:col-span-6">
            <div className="relative aspect-[4/3] overflow-hidden rounded-card shadow-ambient-lg">
              <Image
                ...
                alt="Văn phòng Green Oli và đội ngũ làm việc"
                fill
                priority
          ...
          <div className="lg:col-span-6 space-y-5">
            ...
            <p className="text-text-muted leading-relaxed">
              Năm 2014, Green Oli khởi đầu chỉ với một cửa hàng nhỏ tại Quận 7, TP. Hồ Chí
            ...
            <p className="text-text-muted leading-relaxed">
              ...
              khách hàng dành cho thương hiệu Green Oli.
            </p>
      ...
      <section className="container-page py-14 md:py-20">
        <div className="max-w-3xl mb-12">
          ...
          <h2 className="font-bold text-3xl md:text-4xl text-text-primary leading-tight">
            Bốn nguyên tắc dẫn dắt mọi quyết định của Green Oli
          </h2>
        </div>
      ...
      <section className="bg-surface-light py-14 md:py-20">
        <div className="container-page">
          <div className="max-w-3xl mb-12">
            ...
            <h2 className="font-bold text-3xl md:text-4xl text-text-primary leading-tight">
              Những người đứng sau Green Oli
            </h2>
          </div>
