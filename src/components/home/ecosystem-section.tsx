...
export function EcosystemSection() {
  return (
    <section className="container-page py-16 md:py-20">
      ...
      <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-5 lg:[&>*:first-child]:row-span-2 lg:[&>*:first-child]:col-span-2">
        {SERVICES.map((service, idx) => {
          ...
          return (
            <Link
              key={service.slug}
              href="/lien-he"
              className={`group relative overflow-hidden rounded-card shadow-ambient hover:shadow-ambient-lg transition-shadow ${
